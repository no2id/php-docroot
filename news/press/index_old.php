...
<ul>
	...
	$release_q = "SELECT short_name,title,DATE_FORMAT(release_date,'%e %M %Y') AS date_released FROM press_release WHERE release_date <= now() ORDER BY release_date DESC";
