...
<div style="width:100%;float:left;clear:both;"> 
  ...
  <p>Please feel free to use the banners and buttons below to link back to The NO2ID Pledge, and/or to show people that you have already made the pledge. We have provided the HTML required to display each graphic in a text box beside each banner or button, for you to cut and paste into your own web page.</p>

  <br /><br />
  
  <table id="buttonsTable" align="center">
        <tbody>
          <tr> 
          ...
          <tr> 
            <td colspan="2" style="border-bottom: 1px solid rgb(204, 0, 0); font-size: smaller;">Slightly 
          ...
          <tr> 
            <td colspan="2" style="border-bottom: 1px solid rgb(204, 0, 0); font-size: smaller;">Standard 
          ...
          <tr> 
            <td colspan="2" style="border-bottom: 1px solid rgb(204, 0, 0); font-size: smaller;">Blog-style 
              button</td>
          </tr>
